...
export class createdEventsButton extends Component {
    ...
    render() {
        return (
            <div>
                <div className="bg-coolGrey py-4 pr-20 pl-6 rounded hover:bg-coolGrey-dark hover:shadow-md text-white focus:outline-none focus:shadow-outline mt-5 shadow-xl">
